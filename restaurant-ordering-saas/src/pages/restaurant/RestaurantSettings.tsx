...
import { Download, QrCode as QrCodeIcon, ExternalLink, Copy, Check, Printer, Share2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-text mb-1">QR Code & Menu</h2>
          <p className="text-text-secondary">
            Your digital gateway for customers to browse and order
          </p>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {/* QR Code Main Card */}
        <Card className="lg:col-span-2 overflow-hidden border-2 border-accent/10">
          <div className="p-6">
